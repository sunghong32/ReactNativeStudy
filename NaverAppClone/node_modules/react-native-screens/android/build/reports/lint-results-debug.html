...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      <span class="mdl-layout-title">Lint Report: 6 warnings</span>
      <div class="mdl-layout-spacer"></div>
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Mon Jun 02 19:48:16 KST 2025 by AGP (8.1.1)</nav>
    </div>
  </header>
...
<a name="InternalInsetResource"></a>
...
<span class="location"><a href="../../src/main/java/com/swmansion/rnscreens/Screen.kt">../../src/main/java/com/swmansion/rnscreens/Screen.kt</a>:245</span>: <span class="message">Using internal inset dimension resource <code>status_bar_height</code> is not supported</span><br /><pre class="errorlines">
<span class="lineno"> 242 </span>      .takeIf { resolvedActionBarSize &amp;&amp; headerConfig?.isHeaderHidden != <span class="keyword">true</span> &amp;&amp; headerConfig?.isHeaderTranslucent != <span class="keyword">true</span> }
<span class="lineno"> 243 </span>      ?.let { PixelUtil.toDIPFromPixel(it.toFloat()).toDouble() } ?: <span class="number">0.0</span>
<span class="lineno"> 244 </span>
<span class="caretline"><span class="lineno"> 245 </span>  <span class="keyword">val</span> statusBarHeight = <span class="warning">context.resources.getIdentifier(<span class="string">"status_bar_height"</span>, <span class="string">"dimen"</span>, <span class="string">"android"</span>)</span></span>
<span class="lineno"> 246 </span>      <span class="comment">// Count only status bar when action bar is visible and status bar is not hidden</span>
<span class="lineno"> 247 </span>      .takeIf { it > <span class="number">0</span> &amp;&amp; isStatusBarHidden != <span class="keyword">true</span> &amp;&amp; actionBarHeight > <span class="number">0</span> }
<span class="lineno"> 248 </span>      ?.let { (context.resources::getDimensionPixelSize)(it) }
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/swmansion/rnscreens/Screen.kt">../../src/main/java/com/swmansion/rnscreens/Screen.kt</a>:245</span>: <span class="message">Use of this function is discouraged because resource reflection makes it harder to perform build optimizations and compile-time verification of code. It is much more efficient to retrieve resources by identifier (e.g. <code>R.foo.bar</code>) than by name (e.g. <code>getIdentifier("bar", "foo", null)</code>).</span><br /><pre class="errorlines">
<span class="lineno"> 242 </span>      .takeIf { resolvedActionBarSize &amp;&amp; headerConfig?.isHeaderHidden != <span class="keyword">true</span> &amp;&amp; headerConfig?.isHeaderTranslucent != <span class="keyword">true</span> }
<span class="lineno"> 243 </span>      ?.let { PixelUtil.toDIPFromPixel(it.toFloat()).toDouble() } ?: <span class="number">0.0</span>
<span class="lineno"> 244 </span>
<span class="caretline"><span class="lineno"> 245 </span>  <span class="keyword">val</span> statusBarHeight = context.resources.<span class="warning">getIdentifier</span>(<span class="string">"status_bar_height"</span>, <span class="string">"dimen"</span>, <span class="string">"android"</span>)</span>
<span class="lineno"> 246 </span>      <span class="comment">// Count only status bar when action bar is visible and status bar is not hidden</span>
<span class="lineno"> 247 </span>      .takeIf { it > <span class="number">0</span> &amp;&amp; isStatusBarHidden != <span class="keyword">true</span> &amp;&amp; actionBarHeight > <span class="number">0</span> }
<span class="lineno"> 248 </span>      ?.let { (context.resources::getDimensionPixelSize)(it) }
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/swmansion/rnscreens/ScreenWindowTraits.kt">../../src/main/java/com/swmansion/rnscreens/ScreenWindowTraits.kt</a>:109</span>: <span class="message">Unnecessary; SDK_INT is always >= 21</span><br /><pre class="errorlines">
<span class="lineno"> 106 </span>  <span class="keyword">val</span> translucent = screenForTranslucent?.isStatusBarTranslucent ?: <span class="keyword">false</span>
<span class="lineno"> 107 </span>  UiThreadUtil.runOnUiThread(
<span class="lineno"> 108 </span>      <span class="keyword">object</span> : GuardedRunnable(context) {
<span class="caretline"><span class="lineno"> 109 </span>          <span class="warning"><span class="annotation">@TargetApi</span>(Build.VERSION_CODES.LOLLIPOP)</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 110 </span>          override <span class="keyword">fun</span> runGuarded() {
<span class="lineno"> 111 </span>              <span class="comment">// If the status bar is translucent hook into the window insets calculations</span>
<span class="lineno"> 112 </span>              <span class="comment">// and consume all the top insets so no padding will be added under the status bar.</span></pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/swmansion/rnscreens/ScreenStackFragment.kt">../../src/main/java/com/swmansion/rnscreens/ScreenStackFragment.kt</a>:176</span>: <span class="message">Prefer "<code>SHOW_AS_ACTION_IF_ROOM</code>" instead of "<code>SHOW_AS_ACTION_ALWAYS</code>"</span><br /><pre class="errorlines">
<span class="lineno"> 173 </span>                onSearchViewCreate?.invoke(newSearchView)
<span class="lineno"> 174 </span>            }
<span class="lineno"> 175 </span>            menu.add(<span class="string">""</span>).apply {
<span class="caretline"><span class="lineno"> 176 </span>                setShowAsAction(MenuItem.<span class="warning">SHOW_AS_ACTION_ALWAYS</span>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 177 </span>                actionView = searchView
