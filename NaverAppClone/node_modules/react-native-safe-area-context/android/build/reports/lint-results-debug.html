...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      ...
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Mon Jun 02 19:47:53 KST 2025 by AGP (8.1.1)</nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#ChromeOsAbiSupport"><i class="material-icons warning-icon">warning</i>Missing ABI Support for ChromeOS (1)</a>
    </nav>
  </div>
...
<tr><td class="countColumn"></td><td class="categoryColumn"><a href="#Correctness:Chrome OS">Correctness:Chrome OS</a>
</td></tr>
<tr>
<td class="countColumn">1</td><td class="issueColumn"><i class="material-icons warning-icon">warning</i>
<a href="#ChromeOsAbiSupport">ChromeOsAbiSupport</a>: Missing ABI Support for ChromeOS</td></tr>
...
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:11</span>: <span class="message">A newer version of com.android.tools.build:gradle than 7.3.1 is available: 8.10.1</span><br /><pre class="errorlines">
<span class="lineno">   8 </span>
<span class="lineno">   9 </span>    dependencies {
<span class="lineno">  10 </span>        classpath(<span class="string">"org.jetbrains.kotlin:kotlin-gradle-plugin:$kotlin_version"</span>)
<span class="caretline"><span class="lineno">  11 </span>        <span class="warning">classpath(<span class="string">"com.android.tools.build:gradle:7.3.1"</span>)</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  12 </span>        classpath(<span class="string">"com.diffplug.spotless:spotless-plugin-gradle:6.11.0"</span>)
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:119</span>: <span class="message">Avoid using + in version numbers; can lead to unpredictable and unrepeatable builds (com.facebook.react:react-native:+)</span><br /><pre class="errorlines">
<span class="lineno"> 116 </span><span class="keyword">def</span> kotlin_version = getExtOrDefault(<span class="string">'kotlinVersion'</span>, project.properties[<span class="string">'RNSAC_kotlinVersion'</span>])
<span class="lineno"> 117 </span>
<span class="lineno"> 118 </span>dependencies {
<span class="caretline"><span class="lineno"> 119 </span>    implementation <span class="warning"><span class="string">'com.facebook.react:react-native:+'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 120 </span>    implementation <span class="string">"org.jetbrains.kotlin:kotlin-stdlib:$kotlin_version"</span>
...
<a name="Correctness:Chrome OS"></a>
<a name="ChromeOsAbiSupport"></a>
<section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp" id="ChromeOsAbiSupportCard" style="display: block;">
            <div class="mdl-card mdl-cell mdl-cell--12-col">
  <div class="mdl-card__title">
    <h2 class="mdl-card__title-text">Missing ABI Support for ChromeOS</h2>
  </div>
              <div class="mdl-card__supporting-text">
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:66</span>: <span class="message">Missing x86 and x86_64 ABI support for ChromeOS</span><br /><pre class="errorlines">
<span class="lineno">  63 </span>      buildConfigField <span class="string">"boolean"</span>, <span class="string">"IS_NEW_ARCHITECTURE_ENABLED"</span>, isNewArchitectureEnabled().toString()
<span class="lineno">  64 </span>
<span class="lineno">  65 </span>      ndk {
<span class="caretline"><span class="lineno">  66 </span>          abiFilters (<span class="warning">*reactNativeArchitectures()</span>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  67 </span>      }
<span class="lineno">  68 </span>  }
</pre>

</div>
<div class="metadata"><div class="explanation" id="explanationChromeOsAbiSupport" style="display: none;">
To properly support ChromeOS, your Android application should have an x86 and/or x86_64 binary as part of the build configuration. To fix the issue, ensure your files are properly optimized for ARM; the binary translator will then ensure compatibility with x86. Alternatively, add an <code>abiSplit</code> for x86 within your <code>build.gradle</code> file and create the required x86 dependencies.<br/><div class="moreinfo">More info: <a href="https://developer.android.com/ndk/guides/abis">https://developer.android.com/ndk/guides/abis</a>
</div>Note: This issue has an associated quickfix operation in Android Studio and IntelliJ IDEA.<br>
To suppress this error, use the issue id "ChromeOsAbiSupport" as explained in the <a href="#SuppressInfo">Suppressing Warnings and Errors</a> section.<br/>
<br/></div>
</div>
</div>
<div class="chips">
<span class="mdl-chip">
    <span class="mdl-chip__text">ChromeOsAbiSupport</span>
</span>
<span class="mdl-chip">
    <span class="mdl-chip__text">Chrome OS</span>
</span>
<span class="mdl-chip">
    <span class="mdl-chip__text">Correctness</span>
</span>
...
<span class="mdl-chip">
    <span class="mdl-chip__text">Priority 4/10</span>
              ...
              <div class="mdl-card__actions mdl-card--border">
<button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="explanationChromeOsAbiSupportLink" onclick="reveal('explanationChromeOsAbiSupport');">
Explain</button><button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="ChromeOsAbiSupportCardLink" onclick="hideid('ChromeOsAbiSupportCard');">
Dismiss</button>            </div>
            </div>
          </section>
